...
from qlearn.atari.dqn_agent import AtariDQNAgent
...
def parse_args():
    ...
    parser.add_argument("--agent", type=str, default="DQN", help="which agent to run")
...
if __name__ == '__main__':
    ...
    agent = AtariDQNAgent(args, env.observation_space.shape[-1], num_actions)
    ...
    while True:
        ...
        action = agent.act_e_greedy(np.transpose(np.array(obs)[None], [0, 3, 1, 2]), update_eps=update_eps)
        # import pdb
        # pdb.set_trace()
