...
from qlearn.atari.prior_bootstrapped_agent import AtariPriorBootstrappedAgent
...
def parse_args():
    parser = argparse.ArgumentParser("Boostrapped DQN with prior experiments for Atari games")
    # Environment
    ...
    parser.add_argument("--agent", type=str, default="PriorBoostrappedDQN", help="which agent to run")
    ...
    parser.add_argument('--beta', type=float, default=0.1, help='prior scale')
...
if __name__ == '__main__':
    ...
    agent = AtariPriorBootstrappedAgent(args, env.observation_space.shape[-1], num_actions)
