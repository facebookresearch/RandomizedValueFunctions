...
from qlearn.atari.bootstrapped_agent import AtariBootstrappedAgent
...
def parse_args():
    parser = argparse.ArgumentParser("Boostrapped DQN experiments for Atari games")
    # Environment
    ...
    parser.add_argument("--agent", type=str, default="BoostrappedDQN", help="which agent to run")
...
if __name__ == '__main__':
    ...
    agent = AtariBootstrappedAgent(args, env.observation_space.shape[-1], num_actions)
